import { CardType, Client, PurchaseRequest } from '../types';
...
export class CardService {
  ...
  static calculateDiscount(client: Client, purchase: PurchaseRequest): { discount: number; benefit: string } {
  ...
  static validatePurchaseRestrictions(client: Client, purchase: PurchaseRequest): { isValid: boolean; error?: string } {
    if (client.cardType === CardType.BLACK || client.cardType === CardType.WHITE) {
